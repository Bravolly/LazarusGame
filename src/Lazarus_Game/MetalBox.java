 ...
 */
public class MetalBox extends GameObj implements Observer {
    boolean falling = false;

    public MetalBox(BufferedImage[] sprite) {
        super(sprite);
    }

    public MetalBox(BufferedImage[] sprite, int x, int y, int speed) {
        super(sprite);
        setX(x);
        setY(y);
        this.speed = speed;
